...
// red cards
void CallRedCards(int Card){
      if (Card == 0){											// red 0
	  playerCardNum = "0";
		}	else if ((Card == 1) || (Card == 56)){				// red 1
				playerCardNum = "1";
		}	else if ((Card == 2) || (Card == 57)){				// red 2
				playerCardNum = "2";
		}	else if ((Card == 3) || (Card == 58)){				// red 3
				 playerCardNum = "3";
		}	else if ((Card == 4) || (Card == 59)){				// red 4
				playerCardNum = "4";
		}	else if ((Card == 5) || (Card == 60)){				// red 5
				playerCardNum = "5";
		}	else if ((Card == 6) || (Card == 61)){				// red 6
				playerCardNum = "6";
		}	else if ((Card == 7) || (Card == 62)){				// red 7
				playerCardNum = "7";
		}	else if ((Card == 8) || (Card == 63)){				// red 8
				playerCardNum = "8";
		}	else if ((Card == 9) || (Card == 64)){				// red 9
				playerCardNum = "9";
...
// yellow cards
void CallYellowCards(int Card){
		if (Card == 14){										// yellow 0
			playerCardNum = "0";
		}	else if ((Card == 15) || (Card == 69)){				// yellow 1
				playerCardNum = "1";
		}	else if ((Card == 16) || (Card == 70)){				// yellow 2
				playerCardNum = "2";
		}	else if ((Card == 17) || (Card == 71)){				// yellow 3
				playerCardNum = "3";
		}	else if ((Card == 18) || (Card == 72)){				// yellow 4
				playerCardNum = "4";
		}	else if ((Card == 19) || (Card == 73)){				// yellow 5
				playerCardNum = "5";
		}	else if ((Card == 20) || (Card == 74)){				// yellow 6
				playerCardNum = "6";
		}	else if ((Card == 21) || (Card == 75)){				// yellow 7
				playerCardNum = "7";
		}	else if ((Card == 22) || (Card == 76)){				// yellow 8
				playerCardNum = "8";
		}	else if ((Card == 23) || (Card == 77)){				// yellow 9
				playerCardNum = "9";
...
// green cards
void CallGreenCards(int Card){
	if (Card == 28){											// green 0
	  playerCardNum = "0";
		}	else if ((Card == 29) || (Card == 82)){				// green 1
				playerCardNum = "1";
		}	else if ((Card == 30) || (Card == 83)){				// green 2
				playerCardNum = "2";
		}	else if ((Card == 31) || (Card == 84)){				// green 3
				playerCardNum = "3";
		}	else if ((Card == 32) || (Card == 85)){				// green 4
				playerCardNum = "4";
		}	else if ((Card == 33) || (Card == 86)){				// green 5
				playerCardNum = "5";
		}	else if ((Card == 34) || (Card == 87)){				// green 6
				playerCardNum = "6";
		}	else if ((Card == 35) || (Card == 88)){				// green 7
				playerCardNum = "7";
		}	else if ((Card == 36) || (Card == 89)){				// green 8
				playerCardNum = "8";
		}	else if ((Card == 37) || (Card == 90)){				// green 9
				playerCardNum = "9";
...
// blue cards
void CallBlueCards(int Card){
		if (Card == 42){										// blue 0
			playerCardNum = "0";
		}	else if ((Card == 43) || (Card == 95)){				// blue 1
	  			playerCardNum = "1";
		}	else if ((Card == 44) || (Card == 96)){				// blue 2
	  			playerCardNum = "2";
		}	else if ((Card == 45) || (Card == 97)){				// blue 3
	  			playerCardNum = "3";
		}	else if ((Card == 46) || (Card == 98)){				// blue 4
				playerCardNum = "4";
		}	else if ((Card == 47) || (Card == 99)){				// blue 5
				playerCardNum = "5";
		}	else if ((Card == 48) || (Card == 100)){			// blue 6
				playerCardNum = "6";
		}	else if ((Card == 49) || (Card == 101)){			// blue 7
				playerCardNum = "7";
		}	else if ((Card == 50) || (Card == 102)){			// blue 8
				playerCardNum = "8";
		}	else if ((Card == 51) || (Card == 103)){			// blue 9
				playerCardNum = "9";
...
// If the player's card is red
	if (((Card >= 0) && (Card <= 12)) || ((Card >= 56) && (Card <= 67))){				
      playerCardColor = "red";
	  CallRedCards(Card);
	}
// If the player's card is yellow
	else if (((Card >= 14) && (Card <= 26)) || ((Card >= 69) && (Card <= 80))){				
		playerCardColor = "yellow";
		CallYellowCards(Card);
    }
// If the player's card is green
	else if (((Card >= 28) && (Card <= 40)) || ((Card >= 82) && (Card <= 93))){				
		playerCardColor = "green";
		CallGreenCards(Card);
    }
// If the player's card is blue
	else if (((Card >= 42) && (Card <= 54)) || ((Card >= 95) && (Card <= 106))){				
		playerCardColor = "blue";
		CallBlueCards(Card);
    }
// If the player's card is a wild card
	else if ((Card == 13) || (Card == 27) || (Card == 41) || (Card == 55) || (Card == 68) || (Card == 81) || (Card == 94) || (Card == 107)){				
		playerCardColor = "wild";
			if ((Card == 13) || (Card == 27) || (Card == 41) || (Card == 55)){					// regular wild card
			playerCardNum = "card";
			}	else if ((Card == 68) || (Card == 81) || (Card == 94) || (Card == 107)){		// draw 4 wild card
...
int Points (vector<int> currPlayer){
	...
	for (int j = 0; j < currPlayer.size (); ++j){
		if ((currPlayer.at (j) == 0) || (currPlayer.at (j) == 14)						// zero cards are zero points
	  || (currPlayer.at (j) == 28) || (currPlayer.at (j) == 42)){
				points = points + 0;													// assign no points
	}	else if ((currPlayer.at (j) == 1) || (currPlayer.at (j) == 15)					// one cards are one point
			|| (currPlayer.at (j) == 29) || (currPlayer.at (j) == 43)
			|| (currPlayer.at (j) == 56) || (currPlayer.at (j) == 69)
			|| (currPlayer.at (j) == 82) || (currPlayer.at (j) == 95)){
				points = points + 1;													// assign 1 point
	}	else if ((currPlayer.at (j) == 2) || (currPlayer.at (j) == 16)					// two cards are two points 
			|| (currPlayer.at (j) == 30) || (currPlayer.at (j) == 44)
			|| (currPlayer.at (j) == 57) || (currPlayer.at (j) == 70)
			|| (currPlayer.at (j) == 83) || (currPlayer.at (j) == 96)){
				points = points + 2;													// assign 2 points
	}	else if ((currPlayer.at (j) == 3) || (currPlayer.at (j) == 17)					// three cards are three points
	       || (currPlayer.at (j) == 31) || (currPlayer.at (j) == 45)
	       || (currPlayer.at (j) == 58) || (currPlayer.at (j) == 71)
	       || (currPlayer.at (j) == 84) || (currPlayer.at (j) == 97)){
				points = points + 3;													// assign 3 points
	}	else if ((currPlayer.at (j) == 4) || (currPlayer.at (j) == 18)					// four cards are four points
	       || (currPlayer.at (j) == 32) || (currPlayer.at (j) == 46)
	       || (currPlayer.at (j) == 59) || (currPlayer.at (j) == 72)
	       || (currPlayer.at (j) == 85) || (currPlayer.at (j) == 98)){
				points = points + 4;													// assign 4 points
	}	else if ((currPlayer.at (j) == 5) || (currPlayer.at (j) == 19)					// five cards are five points
	       || (currPlayer.at (j) == 33) || (currPlayer.at (j) == 47)
	       || (currPlayer.at (j) == 60) || (currPlayer.at (j) == 73)
	       || (currPlayer.at (j) == 86) || (currPlayer.at (j) == 99)){
				points = points + 5;													// assign 5 points
	}	else if ((currPlayer.at (j) == 6) || (currPlayer.at (j) == 20)					// six cards are five points
	       || (currPlayer.at (j) == 34) || (currPlayer.at (j) == 48)
	       || (currPlayer.at (j) == 61) || (currPlayer.at (j) == 74)
	       || (currPlayer.at (j) == 87) || (currPlayer.at (j) == 100)){
				points = points + 6;													// assign 6 points
	}	else if ((currPlayer.at (j) == 7) || (currPlayer.at (j) == 21)					// seven card are seven points
	       || (currPlayer.at (j) == 35) || (currPlayer.at (j) == 49)
	       || (currPlayer.at (j) == 62) || (currPlayer.at (j) == 75)
	       || (currPlayer.at (j) == 88) || (currPlayer.at (j) == 101)){
				points = points + 7;													// assign 7 points
	}	else if ((currPlayer.at (j) == 8) || (currPlayer.at (j) == 22)					// eight cards are eight points
	       || (currPlayer.at (j) == 36) || (currPlayer.at (j) == 50)
	       || (currPlayer.at (j) == 63) || (currPlayer.at (j) == 76)
	       || (currPlayer.at (j) == 89) || (currPlayer.at (j) == 102)){
				points = points + 8;													// assign 8 points
	}	else if ((currPlayer.at (j) == 9) || (currPlayer.at (j) == 23)					// nine cards are nine points
	       || (currPlayer.at (j) == 37) || (currPlayer.at (j) == 51)
	       || (currPlayer.at (j) == 64) || (currPlayer.at (j) == 77)
	       || (currPlayer.at (j) == 90) || (currPlayer.at (j) == 103)){
				points = points + 9;													// assign 9 points
	}	else if (((currPlayer.at (j) >= 10) && (currPlayer.at (j) <= 12))				// any action cards are 20 points
	       ...
	       || ((currPlayer.at (j) >= 104) && (currPlayer.at (j) <= 106))){
				points = points + 20;													// assign 20 points
	}	else if ((currPlayer.at (j) == 13) || (currPlayer.at (j) == 27)					// wild cards/wild draw 4's are 50 points
	       || (currPlayer.at (j) == 41) || (currPlayer.at (j) == 55)
	       || (currPlayer.at (j) == 68) || (currPlayer.at (j) == 81)
	       || (currPlayer.at (j) == 94) || (currPlayer.at (j) == 107)){
				points = points + 50;													// assign 50 points
	}
    }
...
bool PlayableCard(vector<int>& currPlayer, vector<int>& Discard){
	...
	for (int i = 0; i < currPlayer.size (); ++i){
		...
		if ((playerCardColor == currCardColor) || (playerCardNum == currCardNum) || (playerCardColor == "wild")){
			playableCard = true;
		}
    }
  return playableCard;
...
// begin player turns
      ...
      counter = GetPoints (player1, player2, player3, player4, player5, player6, player7, player8, player9, player10, playerAmount);
      counter = 0;
      if (player1Out == true){
		  player1Points = GetPoints (player1, player2, player3, player4, player5, player6, player7, player8, player9, player10, playerAmount);
		}	else if (player2Out == true){
		  player2Points = GetPoints (player1, player2, player3, player4, player5, player6, player7, player8, player9, player10, playerAmount);
		}	else if (player3Out == true){
		  player3Points = GetPoints (player1, player2, player3, player4, player5, player6, player7, player8, player9, player10, playerAmount);
		}	else if (player4Out == true){
		  player4Points = GetPoints (player1, player2, player3, player4, player5, player6, player7, player8, player9, player10, playerAmount);
		}	else if (player5Out == true){
		  player5Points = GetPoints (player1, player2, player3, player4, player5, player6, player7, player8, player9, player10, playerAmount);
		}	else if (player6Out == true){
		  player6Points = GetPoints (player1, player2, player3, player4, player5, player6, player7, player8, player9, player10, playerAmount);
		}	else if (player7Out == true){
		  player7Points = GetPoints (player1, player2, player3, player4, player5, player6, player7, player8, player9, player10, playerAmount);
		}	else if (player8Out == true){
		  player8Points = GetPoints (player1, player2, player3, player4, player5, player6, player7, player8, player9, player10, playerAmount);
		}	else if (player9Out == true){
		  player9Points = GetPoints (player1, player2, player3, player4, player5, player6, player7, player8, player9, player10, playerAmount);
